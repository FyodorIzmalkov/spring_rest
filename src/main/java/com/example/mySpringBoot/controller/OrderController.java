...
import com.example.mySpringBoot.controller.exception.OrderNotFoundException;
...
import com.example.mySpringBoot.util.OrderModelAssembler;
...
public class OrderController {
    ...
    public ResponseEntity<RepresentationModel> cancel(@PathVariable Long id) {
        ...
        return ResponseEntity
                ...
                .body(new VndErrors.VndError("Method is not allowed", "You can't cancel an order that is in the "
